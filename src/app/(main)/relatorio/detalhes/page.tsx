...
const ArpolarIcon = ({ className }: { className?: string }) => (
    <Image src="https://i.ibb.co/jL2G9w9/Logo.png" alt="Arpolar Icon" width={32} height={32} className={className} unoptimized/>
);
    ...
    <div className="grid grid-cols-12 gap-0 min-h-[calc(100vh-104px)] -m-6">
        ...
        >
            <div className="flex justify-center mb-2">
                <Image src="https://i.ibb.co/jL2G9w9/Logo.png" alt="Arpolar Icon" width={80} height={80} unoptimized />
            </div>
             ...
             <div className="flex justify-center items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href="/ocorrencias">
                        <Button variant="ghost" size="icon" className="h-16 w-16 text-white/50 hover:text-white"><ArrowRight className="h-12 w-12" /></Button>
                    </Link>
                </div>
